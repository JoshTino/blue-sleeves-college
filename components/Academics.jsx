  ...
  return(
    <section id="academics" className="py-20 px-4">
      ...
      <div className="max-w-6xl mx-auto md:px-4">
        ...
        <h2 className="text-3xl bg-primary text-white py-2 skew-x-7 font-bold text-center mb-12 font-nunito">
          Academic Programs
        </h2>
        ...
        >
          ...
          {programs.map((p,i)=>{
            ...
            return(
              <motion.div
              key={i}
              className="p-6 bg-primary rounded-xl shadow hover:shadow-xl transition flex flex-col items-center"
              variants={{
              ...
              >
                <Icon className="text-secondary mb-4"/>

                <h3 className="text-xl text-secondary font-semibold mb-2 font-nunito">
                  {p.title}
                </h3>
